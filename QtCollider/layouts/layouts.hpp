...
public:
    QcHBoxLayout() {}
    Q_INVOKABLE QcHBoxLayout(const QVariantList& items)
        : QcBoxLayout<QHBoxLayout>(items)
    {
    }
...
public:
    QcVBoxLayout() {}
    Q_INVOKABLE QcVBoxLayout(const QVariantList& items)
        : QcBoxLayout<QVBoxLayout>(items)
    {
    }

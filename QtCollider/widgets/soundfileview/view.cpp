...
QcWaveform::QcWaveform(QWidget *parent):
    ...
    _rangeBeg(0), _rangeDur(0), _rangeEnd(0),

    _cache(0),

    _curSel(0),

    _showCursor(false), _cursorPos(0), _cursorEditable(true),

    _showGrid(true), _gridResolution(1.0), _gridOffset(0.0),

    _beg(0.0), _dur(0.0), _yZoom(1.f), _yOffset(0.f), _spacing(0.1f),

    pixmap(0), _bkgColor(QColor(0, 0, 0)), _peakColor(QColor(242, 178, 0)), _rmsColor(QColor(255, 255, 0)),
    _cursorColor(QColor(255, 0, 0)), _gridColor(QColor(100, 100, 200)), dirty(false), _drawWaveform(true),
    _drawRMS(true),
    // _antialiasing(false), //TODO
    _drawsCenterLine(true), _drawsBoundingLines(true)
{

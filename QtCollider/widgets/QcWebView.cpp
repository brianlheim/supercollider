...
{
    connect(
        page, SIGNAL(jsConsoleMsg(const QString &, int, const QString &)), this,
    ...
    connect(
        page, SIGNAL(navigationRequested(QUrl, QWebEnginePage::NavigationType, bool)), this,
    ...
    connect(
        page, SIGNAL(renderProcessTerminated(RenderProcessTerminationStatus, int)), this,

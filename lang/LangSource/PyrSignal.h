...
PyrObject *signal_poly3r(
    VMGlobals *g, PyrObject *inPyrSignal, float a1, float a2, float b1, float b2, float c1, float c2,
    float slopeFactor);
...
PyrObject *signal_writesplice(
    VMGlobals *g, PyrObject *outc, PyrObject *ina, PyrObject *inb, long indexc, long indexa, long indexb, long fadelen,
    float midamp);
PyrObject *
signal_splice(VMGlobals *g, PyrObject *ina, PyrObject *inb, long indexa, long indexb, long fadelen, float midamp);

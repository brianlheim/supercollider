...
#define MULADD_CALCFUNC(METHOD_NAME) \
    do { \
        set_unrolled_calc_function< \
            MulAdd, &MulAdd::METHOD_NAME<unrolled_64>, &MulAdd::METHOD_NAME<unrolled>, \
...
struct Sum4 : SIMD_Unit
{
    ...
    static void
    sum_vec(float *out, Arg1 const &arg1, Arg2 const &arg2, Arg3 const &arg3, Arg4 const &arg4, int inNumSamples)
    {
        if (SIMD)

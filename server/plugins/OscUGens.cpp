...
force_inline bool UnitGetTable(
    BufUnit* unit, int inNumSamples, const SndBuf*& buf, const float*& bufData, int& tableSize)
{
...
void DegreeToKey_next_a(DegreeToKey* unit, int inNumSamples)
{
    ...
    LOOP1(inNumSamples, int32 index = (int32)floor(ZXP(in));
...
void DetectIndex_next_a(DetectIndex* unit, int inNumSamples)
{
    ...
    LOOP1(inNumSamples, inval = ZXP(in);

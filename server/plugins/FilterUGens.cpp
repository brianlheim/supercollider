...
void SOS_Ctor(SOS *unit)
{
    ...
    if (unit->mBufLength != 1) {
        if (INRATE(1) == calc_FullRate && INRATE(2) == calc_FullRate && INRATE(3) == calc_FullRate &&
            ...
            INRATE(1) == calc_ScalarRate && INRATE(2) == calc_ScalarRate && INRATE(3) == calc_ScalarRate &&
...
static void inline BPerformFilterLoop(
    const Unit *unit, float *out, const float *in, double &y1, double &y2, double a0, double a1, double a2, double b1,
    double b2)
{
    LOOP(unit->mRate->mFilterLoops, double in0 = ZXP(in); double in1 = ZXP(in); double in2 = ZXP(in);
...
static void inline BPerformFilterLoop(
    const Unit *unit, float *out, const float *in, double &y1, double &y2, double a0, double a1, double a2, double b1,
    double b2, double a0slope, double a1slope, double a2slope, double b1slope, double b2slope)
{
    LOOP(unit->mRate->mFilterLoops, double in0 = ZXP(in); double in1 = ZXP(in); double in2 = ZXP(in);

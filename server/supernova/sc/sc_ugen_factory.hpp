...
private:
    ...
    typedef bi::unordered_set<
        sc_unitcmd_def, bi::constant_time_size<false>, bi::power_2_buckets<true>, bi::store_hash<true>>
        unitcmd_set_type;
...
public:
    sc_ugen_def(
        ...
        alloc_size(inAllocSize), ctor(inCtor), dtor(inDtor), flags(inFlags),
...
class sc_plugin_container
{
    ...
    typedef bi::unordered_set<
        sc_ugen_def, bi::constant_time_size<false>, bi::power_2_buckets<true>, bi::store_hash<true>>
        ugen_set_type;

    static const std::size_t bufgen_set_bucket_count = 64;
    typedef bi::unordered_set<
        sc_bufgen_def, bi::constant_time_size<false>, bi::power_2_buckets<true>, bi::store_hash<true>>
        bufgen_set_type;

    static const std::size_t cmdplugin_set_bucket_count = 8;
    typedef bi::unordered_set<
        sc_cmdplugin_def, bi::constant_time_size<false>, bi::power_2_buckets<true>, bi::store_hash<true>>
        cmdplugin_set_type;

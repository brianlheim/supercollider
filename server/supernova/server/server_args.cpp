...
server_arguments::server_arguments(int argc, char *argv[])
{
    ...
    options.add_options()("help,h", "show this help")(
        "udp-port,u", value<uint32_t>(&udp_port)->default_value(0),
        ...
        "type of clock sampleclock=0 systemclock=1")(
        ...
        "<sample-format>")("memory-locking,L", "enable memory locking")(
        ...
        "verbose,V", value<int16_t>(&verbosity)->default_value(0),

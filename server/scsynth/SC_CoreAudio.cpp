...
bool SC_CoreAudioDriver::DriverSetup(int* outNumSamplesPerCallback, double* outSampleRate)
{
    ...
    if (mPreferredSampleRate) {
        ...
        if (UseSeparateIO()) {
            ...
            auto rateListIter = std::set_union(availableSampleRates.begin(), availableSampleRates.end(),
                inputSampleRates.begin(), inputSampleRates.end(), availableSampleRatesInputOutput.begin(),

...
SclangPage::SclangPage(QWidget *parent): QWidget(parent), ui(new Ui::SclangConfigPage)
{
    ...
    connect(
        ui->activeConfigFileComboBox, SIGNAL(currentIndexChanged(const QString &)), this,
...
void SclangPage::writeLanguageConfig()
{
    ...
    QMessageBox::information(
        this, tr("Sclang configuration file updated"),
...
void SclangPage::dialogCreateNewConfigFile()
{
    ...
    QString text = QInputDialog::getText(
        this, tr("New Configuration File"), tr("Create configuration file 'sclang_conf_*.yaml' with '*' replaced by:"),
...
void SclangPage::dialogDeleteCurrentConfigFile()
{
    int ret = QMessageBox::warning(
        this, tr("Delete Configuration File"),
        tr("Are you sure you want to delete the following configuration file?\nThis action is immediate and cannot be "
           "undone.\n") +
